				...
				<article class="login__form__container">
					...
					<div class="login__form">
						...
						<form class="login__input" action="/auth/signin" method="post">
							<!--귀중한 정보니, body에 들고 가려면 post 방식  -->
							<input type="text" name="username" placeholder="유저네임" required="required" /> <input type="password" name="password" placeholder="비밀번호" required="required" />
						...
						<div class="login__facebook">
							...
							<a href="/oauth2/authorization/google"> <img alt="구글 로그인" src="/images/google_login.png" width="200";>
							</a>
						</div>
						<!-- Oauth 소셜로그인end -->
					</div>
